...
@section('page_sub_title' , ' تعديــل مستخدم')
@section('breadcrumb')
                    ...
                    <div class="row">
                        <div class="col">
                            <div >
                                ...
                                <x-text-input id="name" name="name_ar" type="text" class="mt-1 block w-full" :value="$user->name"  autofocus autocomplete="name" />
                        ...
                        <div class="col">
                            <div>
                                ...
                                <x-text-input id="name" name="name_en" type="text" class="mt-1 block w-full" :value="$user->attrByLocale('en' , 'name')"  autofocus autocomplete="name" />
